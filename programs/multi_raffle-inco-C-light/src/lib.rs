...
declare_id!("FETxRpn16JkFzBm8Fwoi1RXapP6uGvScM3jJ5sdjEKHp");
...
#[program]
pub mod multi_raffle_inco_c_light {
    use super::*;
    ...
    pub fn unsafe_join_raffle(
        ...
        user_raffle.number_handle = 0; // TODO: FHE auto-assigned encrypted number
        ...
        msg!("Ticket purchased! Auto-assigned number (encrypted)");
