#!/bin/bash
# Deploy Tixia SFT Collection (CEP-78) to Casper Testnet

set -e

COLLECTION_NAME="Tixia Credits SFT"
COLLECTION_SYMBOL="TIXSFT"
TOTAL_TOKEN_SUPPLY="10000"
COLLECTION_URI="https://raw.githubusercontent.com/dellwatson/moga-mogate/refs/heads/master/metadata/v2-test/collections/casper/tixia/sft/collection.json"
...
echo ""
echo "💾 Save the contract hash to .deployed-collection-tixia-sft-testnet.json"
