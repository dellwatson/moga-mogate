...
const NEW_AUTHORITY_MINT_HASH = "PENDING"; // Will update after deploy finalizes
const PUBLIC_CEP95_HASH =
  "hash-fa2e3339848f555f6d6261b3c53eebd2bfea3074ca38bd491eda882b3397be88"; // PUBLIC CEP-95
...
async function delegateMint() {
  ...
  console.log("NEW Authority Mint:", NEW_AUTHORITY_MINT_HASH);
  console.log("PUBLIC CEP-95:", PUBLIC_CEP95_HASH);
  console.log("");

  // CEP-78 metadata format (JSON string)
  const metadataJson = JSON.stringify({
    name: "Delegate Minted on PUBLIC CEP-95",
    token_uri:
      "https://raw.githubusercontent.com/dellwatson/moga-mogate/refs/heads/master/metadata/v2-test/nfts/casper/tixia/1o1/202/metadata.json",
  });
    ...
    if (
      ...
      if (executionResult.Success) {
        ...
        const proof = {
          ...
          note: "Delegate mint on PUBLIC CEP-95 with NO whitelist check!",
        };
